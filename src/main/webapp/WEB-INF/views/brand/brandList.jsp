	   		...
	   		<dl class="list_division_color">
	   			 <dd>
	   				<ul class = "color_tab">
						...
						<li><a href="javascript:void(0)" class="color_tap_link" data-value="#d5313c" onclick="filterByColor('#d5313c', event)" style="background-color: #d5313c;" title="레드"></a></li>
						...
						<li><a href="javascript:void(0)" class="color_tap_link" data-value="#28438a" onclick="filterByColor('#28438a', event)" style="background-color: #28438a;" title="블루"></a></li>
						
						<li><a href="javascript:void(0)" class="color_tap_link" data-value="#54996a" onclick="filterByColor('#54996a', event)" style="background-color: #54996a;" title="라이트 그린"></a></li>
						...
						<li><a href="javascript:void(0)" class="color_tap_link" data-value="#fdbb33" onclick="filterByColor('#fdbb33', event)" style="background-color: #fdbb33;" title="옐로우"></a></li>
