   ...
   <table id="option_menu" border="1">
      <tr>
         ...
         <td>
            ...
            <button value="d5313c" class="colorBox" 
            style="background-color:#d5313c;  width:20px; height:20px; display:inline-block;" title="레드"></button>
            ...
            <button value="28438a" class="colorBox" 
            style="background-color:#28438a;  width:20px; height:20px; display:inline-block;" title="블루"></button>
            
            <button value="54996a" class="colorBox" 
            style="background-color:#54996a;  width:20px; height:20px; display:inline-block;" title="라이트 그린"></button>
            ...
            <button value="fdbb33" class="colorBox" 
            style="background-color:#fdbb33;  width:20px; height:20px; display:inline-block;" title="옐로우"></button>
      ...
      <c:if test="${not empty subCategory }">
         <div class="option">
            <c:if test="${subCategory=='mtom' }">
               <a href="/finalpro/main.do">종류:맨투맨 x</a>
            </c:if>
            <c:if test="${subCategory=='hood' }">
               <a href="/finalpro/main.do">종류:후드 x</a>
            </c:if>
