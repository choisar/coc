...
<head>
	<script type="text/javascript">
	    ...
	    function fillMySizeInfo() {
			...
			let sizeInfo = document.querySelector(".size_info");
	        ...
	        $.ajax({
	            ...
	            error: function(xhr, status, error) {
	                ...
	                if(xhr.status == 404) {
	                    ...
	                    let td = document.createElement('td');
	                    if(userId!=null && userId!=''){
	                        td.textContent = '사이즈를 등록해보세요.'; // TD에 내용 삽입
	                    }else{
					...
					<div class="info_container_right_side">
						...
						<div class="product_info">
	                        ...
	                        <table>
	                            ...
	                            <tr>
	                                <td>조회수(1개월)</td>
	                                <td class="bold-text">${genderViewList[2]}</td>
	                            </tr>
	                            <tr>
	                                <td>누적 판매량</td>
	                        ...
	                        <div class="tag_area">
		                       	<c:forEach var="tag" items="${tagList}">
		                       		<a href="/finalpro/product/searchList.do?keyword=${tag }&image=" title="관련태그" class="">#${tag }</a>
		                       	</c:forEach>
	                        </div>
						</div>  
						<!-- 가격정보 표시 칸 -->
									...
									<div class="review" itemid="${review.productNo }">
										...
										<div class="review-contents" review_type="goods_estimate" data-review-no="53250844"
											...
											<%-- <div class="review-content-photo">
												<img src="${contextPath}/download.do?imageFileName=${review.imageFileName }&productNo=${review.reviewNo}&path=review">
											</div> --%>
										</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="product-detail__sc-99ltlm-1 eYXAnX">
                            	<c:if test="${!empty dto.color1}"><div  style="width:20px; height:20px; background-color: ${dto.color1 }; display: inline-block;"></div>${dto.color1 } </c:if>
                            	<c:if test="${!empty dto.color2}">,<div  style="width:20px; height:20px; background-color: ${dto.color2 }; display: inline-block;"></div>${dto.color2 } </c:if>
                            	<c:if test="${!empty dto.color3}">,<div  style="width:20px; height:20px; background-color: ${dto.color3 }; display: inline-block;"></div>${dto.color3 } </c:if>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        ...
                        <tr class="isBackground">
                            ...
                            <td class="delivery_company2">
                                ...
                                <img class="packingImg" src="/finalpro/resources/image/changeBox.png" alt="예시 이미지">
                            </td>
                        </tr>
                    </tbody>
                </table>
