...
//   }
   ...
   public ReviewDTO productInfo(String productNo) {
	...
	public int brandCount(String keyword) {
	   ...
	   public List<SearchDTO> searchProductList(Map<String, String> map) {
	      ...
	      if (map.get("keyword").startsWith("#")) {
	         ...
	         System.out.println("red 입력 : " + colorMap.get("red"));
	         System.out.println("green 입력 : " + colorMap.get("green"));
	         System.out.println("blue 입력 : " + blue);
	         System.out.println("orderBy : " + map.get("orderBy"));
	...
	@Override
	public int getLikeCount(String productNo) {
		// TODO Auto-generated method stub
		return dao.getLikeCount(productNo);
	}
